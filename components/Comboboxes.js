...
export default function Comboboxes({ selected, setSelected, projects }) {
        ...
        <Combobox value={selected} onChange={setSelected}>
          <div className="relative mt-1">
            ...
            <Transition
              ...
              afterLeave={() => setQuery("")}
            >
              <Combobox.Options className=" z-50 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
